...
{
    var sql = "INSERT INTO `songs`(`name`, `artist`, `album`, `year`, `duration`, `path`) VALUES ('"+name+"','"+artist+"','"+album+"','"+year+"','"+duration+"','"+path+"')";
...
{
    var query = "UPDATE `songs` SET `name`='"+name+"', `artist`='"+artist+"', `album`='"+album+"', `year`='"+year+"',`duration`='"+duration+"' WHERE id ='"+id+"'";
    connection.query(query, callback);
}
